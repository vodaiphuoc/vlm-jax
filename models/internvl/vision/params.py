"""Utils for loading and converting intern VIT weights."""
...
import tqdm
from .model import InternVLVisionConfig, InternVLVisionModel


def _get_key_and_transform_mapping(cfg: InternVLVisionConfig):
...
def create_model_from_safe_tensors(
    ...
    """Load tensors from the safetensors file and create a InternVLVision model."""
    ...
    intern_vision = nnx.eval_shape(
        lambda: InternVLVisionModel(config, rngs=nnx.Rngs(params=0))
    )

    graph_def, abs_state = nnx.split(intern_vision)
